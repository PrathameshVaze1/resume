...
Drop this folder into Claude Code (or any Claude agent) to get a live LaTeX resume editor: edit by chatting, recompile and visually verify the PDF on every change without opening it in a desktop app, and keep the layout clean and concise — 1–2 pages preferred.
